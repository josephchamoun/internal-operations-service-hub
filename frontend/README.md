...
- `src/pages/` — Login, request list (role-scoped: admin/team/own), request detail (edit while New and unclaimed, claim/unclaim/status/cancel/reassign), and view-only admin pages (users, teams, categories, priorities, access logs, events).
