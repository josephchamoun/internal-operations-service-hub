...
| GET    | `/requests/:id/full`     | —                                                            | Full detail. Requester, owning-team member, or admin only — `403` otherwise. Every successful view is logged (`AccessLog`), including the requester's and admin's own — see `../docs/week3-full-stack-delivery.md` §2 for why. |
